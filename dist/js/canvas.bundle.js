...
function update() {
  ...
  Player.y += Player.velocityY; // Collision detection with ground (assuming ground level at canvas height)
...
function render() {
  // Clear the canvas
  ctx.clearRect(0, 0, canvas.width, canvas.height); // Render player on the canvas
  //   ctx.fillStyle = "red";
